function showContent(section) {
    ...
    `;
        ...
        sectionContent = `
            <h2>자기소개서</h2>
            <p>
             저는 끊임없는 도전과 학습을 통해 성장하는 것을 중요하게 생각합니다. 대학 생활 동안 시행착오를 겪으며 저의 강점과 약점을 파악하고, 목표를 설정하며 발전해왔습니다. 특히, 인공지능(AI)과 데이터 분석 분야에 관심을 가지게 되면서 스스로 공부하고 프로젝트를 진행하며 실력을 쌓아왔습니다.         
            </p>
            <p>
